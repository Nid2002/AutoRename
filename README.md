...
AutoRename é uma ferramenta desenvolvida para renomear automaticamente boletos de faturas condominais em PDF utilizando informações extraídas do próprio documento.
